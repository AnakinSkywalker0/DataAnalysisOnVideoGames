...
**Portfolio:** [ShadowWasHere](https://shadowwashere.artstation.com/)
...
* **Key Steps:**
    1.  **Cleaning:** Removed games with missing names/years and converted 'tbd' scores to `NaN`.
    2.  **EDA:** Visualized the "Hit-Driven" nature of the industry (Action & Sports are dominant).
    3.  **Hypothesis Testing:** Performed a **T-Test** which proved ($p < 0.05$) that games with high critic scores (80+) earn significantly more revenue than average games.
    4.  **Modeling:** Trained a **Linear Regression** model to predict sales from scores.

## 4. Key Insights
1.  **The "Hit" Economy:** The industry is defined by outliers. Most games earn very little, while a few "blockbusters" drive the bulk of the revenue.
2.  **Genre Matters:** **Action** and **Sports** are the safest investment categories.
3.  **Quality Pays:** There is a statistically significant correlation between high review scores and financial success.
4.  **Regional Dominance:** Success in **North America** is the strongest predictor of Global Success (Correlation: 0.94).
